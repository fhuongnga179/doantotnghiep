        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    Bạn có thắc mắc gì không? Hay liên hệ với chúng tôi theo số điện thoại 123456 hoặc tới địa chỉ Phạm Văn Hai, Tân Bình, Tp HCM.
                </p>

                <div class="p-t-27">
                    <a href="https://www.facebook.com/profile.php?id=100022637400669" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
                        <i class="fa fa-facebook"></i>
                    </a>

                    <a href="https://www.instagram.com/phuongnga_1709/" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
        ...
        <div class="p-t-40">
            <div class="flex-c-m flex-w p-b-18">
                <a href="#" class="m-all-1">
                    <img src="\template\images\icons\icon-pay-01.png" alt="ICON-PAY">
                </a>

                <a href="#" class="m-all-1">
                    <img src="\template\images\icons\icon-pay-card.png" alt="ICON-PAY">
                </a>

                <a href="#" class="m-all-1">
                    <img src="\template\images\icons\icon-pay-03.png" alt="ICON-PAY">
                </a>

            </div>

            <p class="stext-107 cl6 txt-center">
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Phuong Nga</a>
